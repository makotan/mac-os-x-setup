...
;; ## added by OPAM user-setup for emacs / tuareg ## 6bb232ca5125c4eb3d0900b90247f2a5 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/Users/makotan/.opam/system/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
